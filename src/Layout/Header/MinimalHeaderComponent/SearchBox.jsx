...
const SearchBox = () => {
  ...
  const { data: categoryData, refetch, isLoading: categoryIsLoading } = useQuery(["CategoryAPIMinimalSearch"], () => request({ url: CategoryAPI, params: { status: 1, paginate : searchValue === "" ? 4:paginate  , search: categoryCustomSearch ? categoryCustomSearch : null, } }), { enabled: false, refetchOnWindowFocus: false, select: (data) => data.data.data });
