      ...
      <Col xs={12}>
        <div className='poster-box'>
          <div className='poster-image'>
            {themeOption?.seller?.about?.image_url && <Image src={themeOption?.seller?.about?.image_url} height={1080} width={1080} alt={themeOption?.seller?.about?.title || 'Seller'} className='w-100' />}
          </div>
        </div>
      </Col>
