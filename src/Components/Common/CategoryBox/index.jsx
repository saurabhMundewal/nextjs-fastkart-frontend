                            ...
                            <div key={index}>
                                {theme == "'paris'" &&
                                    <div>
                                        ...
                                        >
                                            <div>
                                            <Image src={category?.category_icon?.original_url} className='media-height' placeHolder={placeHolderImage} name={category.name} alt={category.name} height={200} width={200} />
    
                                                {/* <Avatar data={category?.category_image} placeHolder={placeHolderImage} name={category.name} /> */}
                                                <h5>{category.name}</h5>
                                            </div>
                                        </Link>
                                    </div>
                                ...
                                {theme == "'rome'" &&
                                    <div className="shop-category-box border-0">
                                        <Link href={`/collections?category=${category?.slug}`} className='circle-1'>
                            ...
                            {categoryData?.length > 0 ? (
                                <Slider {...classes?.sliderOption} className="slider-9 book-category-slider">
                                    {categoryData?.map((elem,i) => (
                                            <Link key={i} href={`/collections?category=${elem?.slug}`} className={`category-box`}>
            ...
            {theme == "'cairo'" &&
                ...
                <Slider {...sliderOptions} className={classes.sliderClass}>
                    {categoryData?.map((data, index) => (
                        <div key={index}>
                            <Link
                                href={`/collections?category=${data?.slug}`}
                                className="cate-box"
                            >
                                <span>{data?.name}</span>
                            </Link>
